...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Constructor<Question> firstConstructor = questionClass.getDeclaredConstructor(
                String.class, String.class, String.class);
        final Constructor<Question> secondConstructor = questionClass.getDeclaredConstructor(
                long.class, String.class, String.class, String.class, Date.class,
                int.class);
